<template>
  <div class="app-container">
	...
	<el-radio-group v-model="ifbaofei">
	  <el-radio-button label="1">预测里程剩余{{tatopdata}}km轮胎</el-radio-button>
	</el-radio-group>
...
<script setup lang="ts" name="Surpluslist">
	...
	onMounted(()=>{
		...
		parameter().then(res=>{
			if(res.code == 200){
				tatopdata.value=res.data.remainingMileageThreshold
				queryform.value.tipMileage=res.data.remainingMileageThreshold
				getList()
			}
			})
