<template>
   <div class="app-container">
      ...
      >
		 ...
		 <el-table-column prop="vehicleNumber" label="总授量" align="center" width="200"></el-table-column>
		 <el-table-column prop="vehicleAvailableNum" label="可用授权量" align="center" width="200"></el-table-column>
      ...
      <el-dialog :title="title" v-model="open" width="600px" append-to-body>
         <el-form ref="deptRef" :model="form" :rules="rules" label-width="120px">
            <el-row>
               <el-col :span="24" v-if="form.deptId == null">
               ...
               <el-col :span="12">
			      ...
			      <!-- <el-col :span="12">
			        <el-form-item label="轮胎授权数量" prop="tireNumber">
			          <el-input v-model="form.tireNumber" type="number" placeholder="轮胎数量" :disabled="isroles"/>
			        </el-form-item>
			      </el-col> -->
			      <!-- <el-col :span="12">
			        <el-form-item label="车辆授权数量" prop="vehicleNumber">
			          <el-input v-model="form.vehicleNumber" :disabled="form.parentId == 0"  type="number" placeholder="车辆数量"  />
			        </el-form-item>
			      </el-col> -->
			     <!-- <el-col :span="12">
			        <el-form-item label="轮毂授权数量" prop="hubNumber">
			          <el-input v-model="form.hubNumber" type="number" placeholder="轮毂数量"  :disabled="isroles"/>
			        </el-form-item>
			      </el-col> -->
               <el-col :span="12">
...
const data = reactive({
  ...
  rules: {
	...
	// vehicleNumber: [ { required: true, message: '车辆授权数量不能为空', trigger: 'blur' },{ pattern:/^([1-9]\d*|[0]{1,1})$/, message: "请输入正确的授权数量", trigger: "blur" }],
	// vehicleNumber: [{ pattern:/^([1-9]\d*|[0]{1,1})$/, message: "请输入正确的授权数量", trigger: "blur" }],
