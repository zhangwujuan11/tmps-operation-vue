<template>
	<div>
		...
		<el-table :data="tabledatacar">
			...
			<el-table-column label="轮位" align="center" prop="hubPositionDesc" />
			<el-table-column label="传感器ID" align="center" prop="rfidCode" />
